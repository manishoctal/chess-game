...
function ODatePicker({ handleDateChange, value,minDate,maxDate ,placeholder}) {
  ...
  return (
    <Flatpickr
      ...
      className="block py-3 px-3 w-full text-sm text-gray-900 bg-transparent border-2 rounded-lg border-[#DFDFDF] appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none max-w-lg focus:ring-0  peer"
      name="date"
