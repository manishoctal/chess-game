          ...
          <form className="sm:py-12 sm:px-11 py-8 px-7" onSubmit={handleSubmit(onSubmit)} method="post">
            ...
            <div className="relative z-0 mb-6 w-full group">
              ...
              <label
                ...
                className="peer-focus:font-normal absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 left-1 bg-white p-2 z-10 origin-[2] peer-focus:left-0 peer-focus:text-[#A5A5A5] peer-focus:text-lg peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8"
                >
