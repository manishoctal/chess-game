...
const Table = ({
    ...
    const handelStatusChange = async (element) => {
        try {
            ...
            const path = `${apiPath.changeUserStatus}/${element?._id}`;
            ...
            <div className="overflow-x-auto relative rounded-lg border">
                <table className="w-full text-xs text-left text-[#A5A5A5] dark:text-gray-400 ">
                    <thead className="text-xs text-gray-900 border border-[#E1E6EE] bg-[#E1E6EE] dark:bg-gray-700 dark:text-gray-400 dark:border-[#ffffff38]">
                        <tr>
                            <th scope="col" className="py-3 px-6" onClick={() => {
                        ...
                        {postData?.length > 0 &&
                            postData?.map((item, i) => (
                                ...
                                >
                                    ...
                                    <td className="py-2 px-4 border-r dark:border-[#ffffff38]">
                                        {startCase(item?.firstName) || "N/A"} {startCase(item?.lastName) || "N/A"}
                                    </td>
                                    <td className="py-2 px-4 border-r dark:border-[#ffffff38]">
                                        <button onClick={() => handleUserView(item)}>{startCase(item?.nickName) || "N/A"}</button>
                                        {/* <a href="">{startCase(item?.nickName) || "N/A"}</a> */}
                                    </td>
                                    <td className="py-2 px-4 border-r dark:border-[#ffffff38]">
                                        {item?.reportCount || 0}
                                    </td>
