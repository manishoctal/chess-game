          ...
          <tbody>
            {subAdmin?.map((item, i) => (
              ...
              >
                ...
                <td className="py-2 px-4 border-r dark:border-[#ffffff38] dark:text-slate-400 text-slate-900 font-bold">
                  {item?.couponCode}
                </td>
                <td className="py-2 px-4 border-r dark:border-[#ffffff38]">
                  {helpers.formattedAmount(item?.couponAmount)}
                </td>
                <td className="py-2 px-4 border-r dark:border-[#ffffff38]">
                      ...
                      <li className="px-2 py-2 hover:text-gradientTo">
                        {helpers.ternaryCondition(
                          ...
                          <button
                            ...
                            title={t("VIEW_SCRATCH_CARD_HISTORY")}
                          >
                            {" "}
                            <AiFillEye className="cursor-pointer w-5 h-5 text-slate-600" />
                          </button>,
                          <span className="text-green-500">{t("UNUSED")}</span>
                        )}
                      </li>
                    </ul>
                  </div>
