...
function Transaction () {
  ...
  const allTransaction = async (data) => {
    try {
      ...
      if (((data?.deletePage && !(artistVerification?.length > 1)) || (isFilter && category && data?.statusChange && !(artistVerification?.length > 1)))) {
        setPage(page - 1)
        setIsDelete(true)
                ...
                <div className='flex items-center lg:pt-0 pt-3 flex-wrap justify-center mb-2 2xl:mb-0'>
                  ...
                  <div className='flex items-center  ml-3 mb-3'>
                    ...
                    >
                      ...
                      <option value='active'>Buyer to seller</option>
                      <option value='pending'>Deposit to wallet</option>
                      <option value='active'>Wallet to source account</option>
                      <option value='pending'>Payment (to artists for their artwork)</option>
                      <option value='active'>Subscription</option>
                      <option value='active'>Refund</option>
                    </select>
                  </div>
                  <button
                    type='button'
