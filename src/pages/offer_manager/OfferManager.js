...
function OfferManager() {
  ...
  return (
    <div>
      <div className="bg-[#F9F9F9] dark:bg-slate-900">
        <div className="px-3 py-4">
          <div className="bg-white border border-[#E9EDF9] rounded-lg dark:bg-slate-800 dark:border-[#ffffff38]">
            <form className="border-b border-b-[#E3E3E3] 2xl:flex gap-2 px-4 py-3 justify-between">
              <div className="col-span-2 flex-wrap items-center">
                <div className="flex items-center lg:pt-0 pt-3  justify-center mb-2 2xl:mb-0">
                  ...
                  <button type="button" onClick={handleOfferReset} title={t("O_RESET")} className="bg-gradientTo text-sm px-6 mx-2 flex mb-3 py-2 rounded-lg items-center border border-transparent text-white hover:bg-DarkBlue">
            ...
            <SubTable subAdmin={subAdmin?.docs} allOfferList={allOfferList} editViewBanner={editViewBanner} page={page} setSort={setSort} sort={sort} manager={manager} pageSize={pageSize} />
      ...
      {editShowModal && <AddEditOffer setEditShowOfferModal={setEditShowOfferModal} getAllOfferData={allOfferList} offerDetails={item} viewType={editView} />}
    </div>
  );
}
