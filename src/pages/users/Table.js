        ...
        <table className="w-full text-xs text-left text-[#A5A5A5] dark:text-gray-400 ">
          <thead className="text-xs text-gray-900 border border-[#E1E6EE] bg-[#E1E6EE] dark:bg-gray-700 dark:text-gray-400 dark:border-[#ffffff38]">
            <tr>
              ...
              <th scope="col" className="py-3 px-6">
                <div className="text-left">{t("O_MOBILE_NUMBER")} (+234)</div>
              </th>
              ...
              users?.map((item, i) => (
                ...
                >
                  ...
                  <td className="py-2 px-4 border-r dark:border-[#ffffff38] dark:border-[#ffffff38] text-center">
                    {item?.dob == null
                      ? "N/A"
                      : dayjs(item?.dob).format("DD MMMM YYYY")}
                  </td>
                      ...
                      <div className="flex justify-center items-center">
                        ...
                        {(manager?.add || user?.role === "admin") &&
                          (item?.verificationStatus == "pending" ? (
                            <div onClick={() => toggleModalAddEdit(item)}>
                              <FaCheck
                                className="text-green text-green-500 text-lg cursor-pointer"
                                title="Verify"
                              />
                            </div>
                          ) : (
                            <div>
                              <FaCheck
                                className="text-green text-green-500 text-lg opacity-40"
                                title={startCase(item?.verificationStatus)}
                              />
                            </div>
                          ))}
                      </div>
