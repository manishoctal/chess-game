...
const ViewPost = ({ onHide, hide, viewData }) => {
                  ...
                  <div className="grid grid-cols-2 items-center">
                    <div className="pl-4">
                      <ul>
                        ...
                        <li className="mb-4">
                          <strong className="mr-2">
                            {t("NO_OF_PEOPLE_REPORTED")}:
                          </strong>
                          {viewData?.reportCount ?? "N/A"}
                        </li>
                        <li className="mb-4">
                          <strong className="mr-2">
                            {t("NO_OF_POST_IMAGES")}:
                          </strong>
                            { viewData?.posts?.length  ? <button onClick={()=>{ onHide(viewData) }}>{viewData?.posts?.length} </button> : 0 }
                        </li>
                      </ul>
                    </div>
                  </div>
